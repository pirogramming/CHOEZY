...
SEED_ITEMS = {
    Category.Code.HEALTH: [
        ...
        },
        {
            ...
            "unit_label": "개월",
            "average_price": 24000,
            "spec_note": "서울 자치구 공공 배드민턴장 월 정기권, 구민 기준",
            "source_name": "서대문구도시관리공단",
            "source_url": "https://www.sscmc.or.kr/page/sports/sub4_3.php",
        },
        {
            "name": "실내 스케이트장 1회",
            "unit_label": "회",
            "average_price": 8000,
            "spec_note": "성인 평일 입장료 4,000원 + 스케이트 대여 4,000원 기준",
            "source_name": "목동아이스링크",
            "source_url": "https://www.mdicerink.com/mdicerink/guide/guide_01.html",
        },
        {
            "name": "테니스장 대관 1회",
            "unit_label": "회",
            "average_price": 8000,
            "spec_note": "서울시설공단 공공 테니스장 실외 코트 1면 2시간 대관, 평일 기준",
            "source_name": "서울시설공단 어린이대공원",
            "source_url": "https://www.sisul.or.kr/open_content/childrenpark/guidance/facility/rent_tennis.jsp",
        },
        {
            "name": "탁구장 이용 1회",
            "unit_label": "회",
            "average_price": 3000,
            "spec_note": "공공체육시설 탁구장 일일자유이용권 2시간 기준, 성인 1인",
            "source_name": "성동구도시관리공단 금호공원체육관",
            "source_url": "https://sports.happysd.or.kr/fmcs/135",
        },
        {
            "name": "실내 클라이밍 1일 이용",
            "unit_label": "회",
            "average_price": 22000,
            "spec_note": "실내 클라이밍장 성인 1일 이용권, 장비 대여 별도",
            "source_name": "더클라임 클라이밍짐",
            "source_url": "http://theclimb.co.kr/?portfolio=membershiop",
        },
    ],
    Category.Code.CULTURE: [
        ...
        },
        {
            ...
            "unit_label": "게임",
            "average_price": 4000,
            "spec_note": "공공체육시설 볼링장 성인 평일 1게임 3,000원 + 볼링화 대여 1,000원 기준",
            "source_name": "성동구도시관리공단 서울숲복합문화체육센터",
            "source_url": "https://sports.happysd.or.kr/fmcs/38",
        },
    ],
}
